...
export const meta: MetaFunction = () => {
  return [
    { title: "WCO Demo - Experience the Web of Tomorrow" },
    {
      name: "description",
      content:
        "A comprehensive demo showcasing the Window Controls Overlay API in a modern Progressive Web App (PWA). Transform your app's title bar into a dynamic, immersive experience.",
    },
    {
      property: "og:title",
      content: "WCO Demo - Window Controls Overlay Demo",
    },
    {
      property: "og:description",
      content:
        "Experience the Window Controls Overlay API - a game-changer for Progressive Web Apps that allows your application to reclaim the title bar area.",
    },
    {
      property: "og:type",
      content: "website",
    ...
    {
      name: "twitter:title",
      content: "WCO Demo - Experience the Web of Tomorrow",
    },
    {
      name: "twitter:description",
      content:
        "A comprehensive demo showcasing the Window Controls Overlay API in a modern Progressive Web App.",
    },
  ];
};
        ...
        <Container maxWidth="md">
          <Stack alignItems="flex-start" gap={3}>
            ...
            <Typography
              ...
              color="neutral"
            >
              This demo showcases how WCO can transform your app's title bar
              into a dynamic, immersive experience that feels{" "}
              <Typography textColor="text.primary" fontWeight="lg">
                truly native
              </Typography>
              .
          ...
          <Stack alignItems="flex-start" gap={1}>
            ...
            {isInstalled ? (
              ...
              >
                ...
                with the Window Controls Overlay API. At the time of writing,
                WCO is supported in Chromium-based browsers like Chrome, or Edge
